...
# ========================================================================
# VLPart VIGOR Stage 1 fine-tuning using the repository .venv.
# This mirrors scripts/train_vigor_vlpart_stage1.sh but does not call conda.
# ========================================================================
...
CUDA_VISIBLE_DEVICES_LIST="${CUDA_VISIBLE_DEVICES_LIST:-1,2}"
NUM_GPUS="${NUM_GPUS:-2}"
...
# ========== SwanLab logging ==========
SWANLAB_ENABLED="${SWANLAB_ENABLED:-true}"
SWANLAB_API_KEY="${SWANLAB_API_KEY:-17UKzqoPx2VI4PLzCHYdH}"
SWANLAB_PROJECT="${SWANLAB_PROJECT:-VLPart}"
SWANLAB_EXP_NAME="${SWANLAB_EXP_NAME:-vigor_swinbase_easy_stage1_bs16_lr4e-5}"
SWANLAB_LOG_PERIOD="${SWANLAB_LOG_PERIOD:-20}"
...
echo "========================================================================"
echo "  VLPart VIGOR Stage 1 fine-tuning (.venv)"
echo "========================================================================"
...
"${PYTHON_BIN}" train_vigor_stage1.py "${ARGS[@]}"
