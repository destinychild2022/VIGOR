...
SAM_MASKS2_DIR="/opt/data/private/LLMSeg/dataset/VIGOR-100K/test/sam_masks3"
SUCCESS_THRESHOLD=0.4
OUTPUT_FILE="./vigor_success_rate_results3.txt"
...
if [ ! -d "$SAM_MASKS2_DIR" ]; then
    echo "警告: SAM masks2目录不存在: $SAM_MASKS2_DIR"
fi
...
echo "SAM masks2 dir: $SAM_MASKS2_DIR"
